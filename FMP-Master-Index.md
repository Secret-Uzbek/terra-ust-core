# FMP MASTER INDEX
## Complete Project Catalog with UST Integration

**Last Updated:** February 14, 2026  
**Total Projects:** 3 active + 363 planned (366-day calendar)  
...
**Summary:**
Meta-fractal component enabling semantic translation across:
- 7+ languages (Chagatai, Uzbek, Urdu, Hindi, English, Russian, Persian)
- 3 layers (lexical, semantic, epistemic)
- All FMP projects depend on UST

**Key Deliverables:**
- [ ] UST Alpha (Mar 2026)
- [ ] UST Beta (Jun 2026)
- [ ] UST v1.0 Production (Dec 2026)
- [ ] 50,000+ translations by end of year

**Team:**
- Abdurashid Abdukarimov (architect)
...
**Summary:**
Complete digitization of Alisher Navoi's works (1441-1501):
- Khamsa (five epic poems)
- Lisan al-Tayr (Language of Birds)
- Mahbub al-Qulub (Beloved of Hearts)
...
**Key Deliverables:**
- [ ] 10,000 pages digitized (Mar 2026)
- [ ] Semantic annotation tool (Apr 2026)
- [ ] Audio pronunciations (May 2026)
- [ ] Educational modules (Jun 2026)

**Partners:**
- Uzbek State World Languages University (UzSWLU)
- Alisher Navoi National Library (Tashkent)
- Institute of Oriental Studies (Tashkent)

**Funding:**
- Phase 1: University partnerships (in-kind)
- Phase 2: UNESCO grant application ($50K, pending)
...
**Summary:**
13-module analysis of Babur's legacy (1483-1530):
- From Ferghana exile to Mughal Empire
- British Partition consequences (Kashmir, Pakistan)
- Cultural impact (Taj Mahal, Bollywood, tea)
...
**Partners:**
- Uzbek Ministry of Investments & Foreign Trade
- Indian Ministry of External Affairs (proposed)
- Shanghai Cooperation Organisation (proposed)

**Funding:**
- Phase 1: Self-funded research
- Phase 2: Policy consulting contracts ($50-100K, 2026)
...
2. Jan 10: Peace as Fractal Process
3. Jan 19: Women in Power
4. Jan 27: Musical Fractals East-West
5. [+2 more]
...
### March-December (350+ projects)
[See `/FMP-366-Day-Calendar-v1.0.md` for full listing]

**Integration Pattern:**
Every project:
1. Uses UST for translation
2. Adds data to FMP knowledge graph
3. Contributes to overall paradigm
4. Published in multiple languages
...
**Current (Feb 2026):**
- UST development: 20 hours
- Babur-Terra: 15 hours
- Navoi Corpus: 10 hours
...
- New projects: 15 hours
- Research/writing: 15 hours
- Strategy/fundraising: 10 hours
- **Total: 50 hours, but with 5x output** (team multiplier)

### Funding Roadmap

**2026:**
- Q1: $0 (bootstrap)
- Q2: $100-200K (seed grants)
- Q3: $200-300K (partnerships)
- Q4: $300-500K (major grants)
- **Total Year 1: $600K-1M**

**2027:**
- Establish research lab
- Hire core team (7-10 people)
- **Budget: $1-2M**
...
- Abdurashid's location
- Access to archives, universities
- Neutral geopolitical position

**Virtual:** Global
- GitHub (open source)
- Academic networks (UzSWLU, JNU, SOAS)
- Policy engagement (remote)

### Target (2030)
**Tashkent:** Main campus
- FMP Research Institute building
- 200+ staff
- Conference facilities

**Satellite Offices:**
- Delhi (India): South Asian operations
- London (UK): European partnerships
- Beijing (China): East Asian expansion
- Istanbul (Turkey): Turkic world hub
...
- [ ] 500+ papers (2030)
- [ ] FMP Prize = Nobel-level recognition (2035)

### Policy Metrics
- [ ] 1 government adopts FMP proposal (2027)
- [ ] 5 governments (2030)
- [ ] UN/UNESCO partnership (2032)
...
- [ ] 100 articles (2028)
- [ ] 1000+ articles, TV docs, books (2032)
...
**Monthly:** Public newsletter (launch Q2 2026)  
**Quarterly:** Major releases (UST versions, new projects)  
**Annually:** FMP Conference (start 2027)
...
**Contact:** abdurashid.abdukarimov@fmp.uz
